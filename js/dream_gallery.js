const details = [
  ...
  {
    title: "Subway Connection",
    description:
      "The subway rattled through the city’s veins, a blur of faces and fleeting lives, but there we stood, hands touching on the same steel pole. Your fingers, warm against the cold metal, sent whispers of connection through the crowd. In that shared grip, amidst the chaos, I felt the world shrink to just us—two hearts finding each other in the rush.",
  },
  {
